...
[`K.js`](https://github.com/ctubio/Krypto-trading-bot) is a very low latency cryptocurrency [market making](https://github.com/ctubio/Krypto-trading-bot/blob/master/MANUAL.md#what-is-market-making) trading bot with a full featured [web interface](https://github.com/ctubio/Krypto-trading-bot#web-ui), it directly connects to [several cryptocoin exchanges](https://github.com/ctubio/Krypto-trading-bot/tree/master/etc#configuration-options). On a decent machine, it reacts to market data by placing and canceling orders in under a millisecond.
