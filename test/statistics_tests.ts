...
describe("EwmaStatisticCalculator", () => {
    it("Should work", () => {
        ...
        var calc = new Stats.EwmaStatisticCalculator(new QuotingParameters.QuotingParametersRepository(null, null, {longEwmaPeridos:20.0526}, null), 'longEwmaPeridos', <Models.RegularFairValue[]>input.map(x => new Models.RegularFairValue(new Date(), x)));
