                        ...
                        <tr class="active">
                            ...
                            <td style="min-width:121px;border-bottom: 3px solid #DDE28B;" *ngIf="params.autoPositionMode">
                                <select class="form-control input-sm"
                                   ...
                                   <option *ngFor="let option of availablePositionDivergenceModes" [ngValue]="option.val">{{option.str}}</option>
                                </select>
                            </td>
                            ...
                            <td style="min-width:121px;border-bottom: 3px solid #D64A4A;">
                                <select class="form-control input-sm"
                                   ...
                                   <option *ngFor="let option of availableAggressivePositionRebalancings" [ngValue]="option.val">{{option.str}}</option>
                                </select>
                            </td>
...
export class SettingsComponent implements OnInit {
  ...
  private availableQuotingModes = [];
  private availableOrderPctTotals = [];
  private availableQuotingSafeties = [];
  private availableFvModels = [];
  private availableAutoPositionModes = [];
  private availablePositionDivergenceModes = [];
  private availableAggressivePositionRebalancings = [];
  private availableSuperTrades = [];
  private availablePingAt = [];
  private availablePongAt = [];
  private availableSTDEV = [];

  private fireCxl: Socket.IFire<Models.QuotingParameters>;
  ...
  ngOnInit() {
    ...
    this.availableQuotingSafeties = this.getMapping(Models.QuotingSafety);
    this.availableFvModels = this.getMapping(Models.FairValueModel);
    this.availableAutoPositionModes = this.getMapping(Models.AutoPositionMode);
    this.availableAggressivePositionRebalancings = this.getMapping(Models.APR);
    this.availablePositionDivergenceModes = this.getMapping(Models.DynamicPDivMode);
    this.availableSuperTrades = this.getMapping(Models.SOP);
    this.availablePingAt = this.getMapping(Models.PingAt);
    this.availablePongAt = this.getMapping(Models.PongAt);
