...
@Component({
  ...
  template: `<ag-grid-angular #marketList (click)="this.loadSubscriber()" class="ag-fresh ag-dark {{ subscribed ? \'ag-subscribed\' : \'ag-not-subscribed\' }} marketTrades" style="height: 334px;width: 100%;" rowHeight="21" [gridOptions]="gridOptions"></ag-grid-angular>`
})
