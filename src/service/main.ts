...
var defaultQuotingParameters : Models.QuotingParameters = new Models.QuotingParameters(2, 0.01, Models.QuotingMode.Boomerang, Models.FairValueModel.BBO, 1, 0.9, true, Models.AutoPositionMode.EwmaBasic, false, 0.9, 569, .095, 2*.095, .095, 3, .1);
