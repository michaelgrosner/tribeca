...
# command-line examples:
 ...
 $ K-hello-world > my_log_file 2>&1          # write logs and result to file
 $ K-hello-world 2> my_log_file > my_result  # write logs and result to different files
 $ K-hello-world | cowsay                    # verbose speaking cow notification
 $ K-hello-world 2> /dev/null | cowsay       #  clean  speaking cow notification
